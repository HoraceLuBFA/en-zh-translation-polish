...
- 明确触发范围：英文段落翻译，以及对照原文润色中文译稿；需要图表与参考文献处理的完整论文交由 `pdf-paper-zh-translation`。
...
- Clarify triggering for English passages and source-grounded polishing of Chinese translations; route complete papers with figures and references to `pdf-paper-zh-translation`.
